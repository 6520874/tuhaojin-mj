...
namespace WidgetFun
{
	...
	{
		Node* pScenceNode = getChildWidgetByName(pNode,kName);
	...
	{
		CCAssert(pNode,"");
		LabelTTF* pLabel = castNode<cocos2d::LabelTTF>(pNode);
	...
	{
		cocos2d::LabelTTF* pLabel = castNode<cocos2d::LabelTTF>(pNode);
	...
	{
		Node* pWidget = getChildWidgetByName(pNode,kName);
		CCLabelTTF* pLabel = castNode<CCLabelTTF>(pWidget);
		CCAssert(pLabel,"");
	...
	{
		setVisible(getChildWidget(pNode,kName),bVisible);
	}
